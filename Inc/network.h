...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 17, 1, NULL), \
}
#define AI_NETWORK_OUT_SIZE { \
  (1 * 1 * 17), \
}
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 17)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 17) * 4)
