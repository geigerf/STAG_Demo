...
const float tactile_scale = 1/(2500.0 - 1500.0);
uint8_t pred_class;
...
static void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = 107; // One step is 1µs
...
static void MX_TIM7_Init(void)
{
  ...
  htim7.Init.Period = 1349; // The timer will fire at 8Hz
...
static void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.BaudRate = 460800; //921600 22ms per frame; 230400 88ms per frame
